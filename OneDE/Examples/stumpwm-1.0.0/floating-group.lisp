...
(defpackage #:onede.floating-group
  (:use :cl :onede)
  (:export #:float-group))

(in-package :onede.floating-group)
...
(defcommand gnew-float (name) ((:rest "Group Name: "))
  ...
  (add-group (current-screen) name :type 'onede.floating-group:float-group))
...
(defcommand gnewbg-float (name) ((:rest "Group Name: "))
  ...
  (add-group (current-screen) name :background t :type 'onede.floating-group:float-group))
